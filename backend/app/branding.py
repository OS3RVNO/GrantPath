...
PRODUCT_SHORT_DESCRIPTION = (
    "Graph-powered access intelligence for IAM, Active Directory, file servers and ACLs. "
    "Explain access, review exposure and simulate changes before they break production."
)
