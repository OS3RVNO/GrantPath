...
PRODUCT_SHORT_DESCRIPTION = (
    "Graph-powered access intelligence for IAM, Active Directory and file server permissions. "
    "Explain who has access, why it exists and what changes before you remove it."
)
